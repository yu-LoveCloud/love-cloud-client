...
function SignUp() {
  ...
  const handleRoleChange = (role) => {
    setData({
      ...data,
      weddingRole: data.weddingRole === role ? "" : role,
    });
  };
        ...
        <form>
          ...
          <div>
            ...
            <Input
              ...
              onChange={handleChange}
            />
            <h4 style={{ marginTop: "20px", marginBottom: "4px" }}>
              비밀번호 확인
            </h4>
            <Input
          ...
          <div style={{ display: "flex", marginTop: "40px" }}>
            <div style={{ width: "33%" }}>
              <label>
                <CheckInput
                  type="checkbox"
                  checked={data.weddingRole === "GROOM"}
                  onChange={() => handleRoleChange("GROOM")}
                />
                신랑
              </label>
            </div>
            <div style={{ width: "33%" }}>
              <label>
                <CheckInput
                  type="checkbox"
                  checked={data.weddingRole === "BRIDE"}
                  onChange={() => handleRoleChange("BRIDE")}
                />
                신부
              </label>
            </div>
          ...
          <ButtonWrapper>
            <PurpleButton as="button" type="submit" onClick={handleSignUp}>
              회원가입하기
            </PurpleButton>
          </ButtonWrapper>
        </form>
...
export default SignUp;
>>>>>>> cc6d5c0992a2ef1a419a260aa5676ef60efcabb4
